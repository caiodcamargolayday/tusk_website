...
export default function Footer() {
  ...
  return (
    <footer className="bg-[var(--color-tusk-dark)] text-[var(--color-tusk-beige)] py-20 px-6 border-t border-[var(--color-tusk-beige)]/20">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-start gap-12 md:gap-8">
        ...
        <div className="flex flex-col gap-4">
          ...
          <ul className="flex flex-col gap-2">
            <li><a href="#specials" className="font-light hover:text-white opacity-80 hover:opacity-100 transition-colors">Specials</a></li>
      ...
      <div className="max-w-7xl mx-auto mt-20 pt-8 border-t border-[var(--color-tusk-beige)]/10 flex items-center justify-center">
